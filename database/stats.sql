CREATE OR REPLACE SEQUENCE genre_seq;
...
CREATE OR REPLACE SEQUENCE achat_seq;
CREATE TABLE achats(
...
CREATE OR REPLACE VIEW v_initial AS
SELECT
    p.id_produit,
    f.id_format,
    g.id_genre,
...
CREATE OR REPLACE VIEW v_stat_produit_format_genre AS
SELECT
    c.id_genre,
    a.id_produit,
    a.id_format,
...
GROUP BY
    ...
    a.id_produit,
    a.id_format;
CREATE OR REPLACE VIEW v_stat_initiale AS
SELECT
    vi.id_produit,
    vi.id_format,
    vi.id_genre,
