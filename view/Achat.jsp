...
<%@page import="model.mouvement.Achat"%>
<%

    Formulaire formulaire = new Achat().createFormulaire("insert");
    formulaire.setTitle("Insertion de Achat");
    formulaire.setRedirect("/poketra/Achat.jsp");
    formulaire.setRedirectError("/poketra/Achat.jsp?error=");
