...
<%
    ...
    Mouvement[] sorties = Mouvement.getSortiesNonValide();
...
<body>
    <div class="bg-white shadow-sm p-5 rounded-3 container w-75 mt-5">
        <h2>Liste des sorties non validées</h2>
        <table class="table mt-4">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle"><%=sortie.getStatusLettre() %></td>
                <td class="align-middle"><a href="./validation.jsp?sortie=<%=sortie.getId() %>" class="btn btn-outline-info">Valider</a></td>
              </tr>
              <% } %>
            </tbody>
          </table>
