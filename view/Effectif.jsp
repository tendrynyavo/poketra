...
<%@page import="model.employees.EffectifFormat"%>
<%

    Formulaire formulaire = new EffectifFormat().createFormulaire("insert");
    formulaire.getListeChamp()[2].setVisible(false);
    formulaire.setTitle("Insertion de Effectif");
    formulaire.setRedirect("/poketra/Effectif.jsp");
    formulaire.setRedirectError("/poketra/Effectif.jsp?error=");
